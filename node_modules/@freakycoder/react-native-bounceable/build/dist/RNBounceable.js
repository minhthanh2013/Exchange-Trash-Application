...
class RNBounceable extends React.Component {
    constructor(props) {
        ...
        this.springAnimation = () => {
            ...
            const { bounceEffect = 0.9, bounceFriction = 3, useNativeDriver = true, onPress, } = this.props;
    ...
    render() {
        ...
        return (<react_native_1.TouchableWithoutFeedback {...this.props} onPress={this.springAnimation.bind(this, react_native_1.Easing.bounce)}>
